...
//#endregion
export { Config, MCP_LOADING_MODES, MCP_SETTINGS_NAMESPACE, McpManager, admits, apply, assertServerName, filterHidesAnything, filterMcpTools, flattenSpec, inject, mcpEntryConfig, mcpRowKey, name, parseMcpLoadingMode, parseMcpToolFilter, parseSpecText, parseSpecValue, registerMcpSettings, registerMcpTools, scanClaudeMcp, secretKeys, serverNameFromCommand, specFromEntryConfig, specFromObject, toolRuleEntries };
