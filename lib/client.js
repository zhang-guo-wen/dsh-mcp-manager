window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function McpEditor({ open, mode, server, disabled, busy, error, describeMcp, listMcpTools, presets, globalProblemReason, descriptionInitial, onUpdateDescription, toolRulesInitial, onUpdateTools, t, onClose, onSubmit }) {
			...
			*/
			...
			const globalUnavailable = mode === "add" && globalProblemReason !== void 0;
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "",
											disabled: globalUnavailable,
											children: globalUnavailable ? t("mcp.scopeGlobalReadOnly") : t("mcp.scopeGlobal")
										}),
								...
								globalUnavailable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(McpEditor, {
							...
							listMcpTools,
							presets,
							...globalProblemReason === void 0 ? {} : { globalProblemReason },
		...
		*/
		...
		const zh = {
			...
			"mcp.scopeGlobal": "全局",
			"mcp.scopeGlobalReadOnly": "全局（当前不可写）",
		...
		const en = {
			...
			"mcp.scopeGlobalReadOnly": "Global (read-only here)",
